...
function dummyProviders() {
	return [
		{id: "rec1", name: "Eugene Mission", category: "rec1", subcategories: ["rec1", "rec2"], city: "rec1"},
		{id: "rec2", name: "Lane Food Pantry", category: "rec1", subcategories: ["rec2"], city: "rec1"},
		{id: "rec3", name: "James Law Firm", category: "rec2", subcategories: ["rec4"], city: "rec2"},
		{id: "rec4", name: "Cody Law Firm", category: "rec2", subcategories: ["rec3", "rec4"], city: "rec1"},
		{id: "rec5", name: "Lane Community College", category: "rec3", subcategories: ["rec5"], city: "rec1"},
		{id: "rec6", name: "Jimmys Soup Kitchen", category: "rec1", subcategories: ["rec2"], city: "rec3"},
		{id: "rec7", name: "Creswell Community College", category: "rec3", subcategories: ["rec5"], city: "rec2"}
	];
}
